...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          cvats saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets cvats apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than cvats, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, cvats
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. cvats is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, cvats intentionally only offers
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        that led to cvats, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that cvats can help
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          The best way to support cvats is to share your thoughts and
        ...
        <p>
          Another great way to support cvats is by spreading the words.
