...
const testimonialSpiegelSrc = "/assets/testimonial-spiegel.jpg";
const testimonialSantiSrc = "/assets/testimonial-santi.jpg";
const testimonialVivianSrc = "/assets/testimonial-vivian.jpg";
