...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          usar diferentes marcadores ou estilos de fonte após copiar e colar.
          Por outro lado, um criador de currículos economiza tempo e evita erros
          de formatação ao formatar automaticamente o currículo. Ele também
          oferece a conveniência de alterar facilmente tipos ou tamanhos de
          fonte com um simples clique. Em resumo, um criador de currículos é
          mais fácil de usar em comparação com um modelo de currículo.
        </p>
      </>
    ),
  },
      ...
      <>
        ...
        <p>
          <span className="font-semibold">
            1. Otimização específica para sistemas ATS (Applicant Tracking
            System).
          </span>
          <br />
          ...
          referências. Além disso, usa apenas design de coluna única de cima
          para baixo, porque este formato funciona melhor com sistemas ATS e
          maximiza suas chances de aprovação. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
          ...
          <br />
          Enquanto outros criadores de currículos podem exigir cadastro por
          email e armazenar dados de usuários em seus bancos de dados,
          acreditamos que os dados do currículo devem permanecer privados e
          acessíveis apenas na máquina local do usuário. Por isso, não exigimos
          cadastro para usar o aplicativo, e todos os dados inseridos são
          armazenados no navegador do usuário, onde apenas você tem acesso.
        </p>
      </>
    ),
  },
  {
    question:
      "P3. Por que criar currículos otimizados para ATS é tão importante?",
    answer: (
      <p>
        ...
        automatizados analisam e classificam currículos com base em
        palavras-chave, formatação e estrutura. Um currículo mal formatado ou
        que não seja compatível com ATS pode ser rejeitado automaticamente,
        mesmo que você seja o candidato perfeito para a vaga. Este criador de
        currículos foi desenvolvido especificamente para garantir que seu
        currículo passe por esses filtros automatizados, aumentando
        drasticamente suas chances de ser visto por um recrutador real e
        conseguir aquela entrevista tão desejada. Nossa missão é ajudar qualquer
        pessoa a criar facilmente um currículo profissional e moderno que siga
        as melhores práticas e permitir que todos se candidatem a empregos com
        confiança.
      </p>
    ),
  },
...
export const QuestionsAndAnswers = () => {
  ...
  // Dados estruturados para FAQ (Schema.org)
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "O que é um criador de currículos? Por que é melhor que modelos de documento?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Um criador de currículos é uma ferramenta online que permite inserir suas informações e gera automaticamente um currículo formatado. É melhor que modelos de documento porque economiza tempo, evita erros de formatação e oferece conveniência para alterar facilmente tipos ou tamanhos de fonte com um simples clique.",
        },
      },
      {
        "@type": "Question",
        name: "O que torna este criador de currículos único em relação a outros?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Este criador de currículos se destaca por duas características: 1) Otimização específica para sistemas ATS, focando em recursos que funcionam perfeitamente com sistemas de rastreamento de candidatos. 2) Foco total em privacidade e segurança, com todos os dados armazenados localmente no navegador do usuário.",
        },
      },
      {
        "@type": "Question",
        name: "Por que criar currículos otimizados para ATS é tão importante?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Mais de 98% das grandes empresas e 66% das empresas em geral utilizam sistemas ATS para filtrar currículos. Um currículo mal formatado ou incompatível com ATS pode ser rejeitado automaticamente. Este criador garante que seu currículo passe por esses filtros, aumentando suas chances de ser visto por recrutadores.",
        },
      },
      {
        "@type": "Question",
        name: "Como posso apoiar este projeto?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Você pode apoiar compartilhando feedback, divulgando para amigos e nas redes sociais, ou dando uma estrela no Github. Nosso objetivo é alcançar mais pessoas que precisam criar currículos profissionais.",
        },
      },
    ],
  };
        ...
        <div className="mx-auto max-w-3xl">
          <div className="space-y-4 lg:space-y-6">
            {QAS.map(({ question, answer }, index) => {
              ...
              return (
                <div key={question} className="group relative transition-all">
                  ...
                  <div className="relative z-10 overflow-hidden rounded-xl border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                    ...
                    >
                      ...
                      <div
                        className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg border-3 border-black ${color} shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-transform ${
                          isOpen ? "rotate-180" : ""
                        }`}
                      >
